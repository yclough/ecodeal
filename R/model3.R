...
#'
#' @format A model with a response and seven explanatory variables:
#' \describe{
...
#'   \item{Lat}{Latitude in WGS 1984 World Mercator}
#'   \item{Lon}{Longitude in WGS 1984 World Mercator}
